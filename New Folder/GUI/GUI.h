...
public:
	...
	void UpdateStatusBar(int TimeStep,double h,CASTLE_STATUS s,int AF,int Afr,int AH,int TA,int FrF,int FrFre,int FrH,int TFr,int KF,int KFr,int KH,int TK);	//prints info on status bar. Info includes timestep and other enemies info as illustrated in project doc
	void UpdateInterface(int TimeStep,double h,CASTLE_STATUS s,int AF,int Afr,int AH,int TA,int FrF,int FrFre,int FrH,int TFr,int KF,int KFr,int KH,int TK);
